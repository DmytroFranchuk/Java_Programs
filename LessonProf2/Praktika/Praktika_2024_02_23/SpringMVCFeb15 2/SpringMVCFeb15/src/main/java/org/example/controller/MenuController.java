...
public class MenuController {
    ...
    @PostMapping()
    public DishCreateRequestDto create(@RequestBody DishCreateRequestDto candidate){
        return service.create(candidate);
    }
    @GetMapping("/{id}")
    public DishCreateRequestDto read(@PathVariable("id") long id){
        return service.read(id);
    }
    @GetMapping()
    public List<DishCreateRequestDto> readAll(){
