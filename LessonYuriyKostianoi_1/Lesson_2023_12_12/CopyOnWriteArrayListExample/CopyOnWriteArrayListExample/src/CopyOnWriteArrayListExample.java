...
/**
 * В примере формируется набор данных lst, на основании которого создается потокобезопасная коллекция list типа
 * CopyOnWriteArrayList. Данные коллекции list с помощью итератора выводятся в консоль два раза.
