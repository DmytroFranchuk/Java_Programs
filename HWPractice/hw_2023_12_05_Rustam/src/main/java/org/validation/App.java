...
// POST /employee
// POST запрос, который должен принимать в себя JSON объект с данными о сотруднике. Этот объект должен
// сохраняться в базу, если такой объект в базе уже есть - информация в полях должна обновляться новыми данными.
// GET /employee
