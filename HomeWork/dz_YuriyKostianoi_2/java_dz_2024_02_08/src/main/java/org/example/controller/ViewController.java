...
public class ViewController {
    ...
    @GetMapping("/status")
    public String getStatusForm(Model model) {
        model.addAttribute("users", userService.getAllUsers());
        return "user_status_form";
    }

    @PatchMapping("/submit")
    public String updateUserStatus(@RequestParam("userId") Long userId, @RequestParam("status") Status status, Model model) {
        model.addAttribute("user", userService.updateStatus(userId, status));
